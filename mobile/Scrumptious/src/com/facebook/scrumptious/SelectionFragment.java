...
//        listElements.add(new PhotoListElement(3));
        // ia datele din baza de date toate elementele ordonate
        // crescator dupa parinte
        // listElements.add(new ListViewDemo(4));
        int index = 0;
        int expectedParent = 0; // first expected parent
        int currentParent = 0; // reached from server
        boolean goOn = true;
        while (goOn) {
        	listElements.add(new ListViewDemo(
        			"hardcodedIcon",
        			"hardCodedName " + index,
        			"hardCodedHint " + index,
        			index));
    ...
    private class ListViewDemo extends BaseListElement {

		public ListViewDemo(/*Drawable icon*/String icon, String name, String shortDescription, int requestCode) {
